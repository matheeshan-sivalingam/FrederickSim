...
if("TRUE" STREQUAL "TRUE")
  set(mpu_6050_driver_SOURCE_PREFIX /home/matheeshan/frederick/catkin_ws/src/mpu_6050_driver)
  set(mpu_6050_driver_DEVEL_PREFIX /home/matheeshan/frederick/catkin_ws/devel)
  ...
  set(mpu_6050_driver_INSTALL_PREFIX /home/matheeshan/frederick/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu_6050_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matheeshan/frederick/catkin_ws/src/mpu_6050_driver/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mpu_6050_driver_EXPORTED_TARGETS ${${mpu_6050_driver_dep}_EXPORTED_TARGETS})
endforeach()
